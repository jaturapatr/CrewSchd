...
def apply_history_constraints(model, schedule, employee_ids, start_date, shifts, rosters_dir):
    """
...
def apply_persistence_locks(model, schedule, employee_ids, days, shifts, rosters_dir):
    """
    STABILITY ENGINE:
    ...
    if future_anchors:
        print(f"⚓ STABILITY ANCHOR: Found {len(future_anchors)} days of future assignments in {rosters_dir} to protect...")
